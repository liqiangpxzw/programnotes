...
public class MD5 {
	...
	/*
	 * 带排序的加密
	 * mapping  controller里的映射
	 * param      参数,要加密的部分
	 * key			加密密钥
	 * */
	public static String encode(String mapping, String param, String key,String sign_type) {
		/* url参数排序重构 */
		Map<String, String> treeMap = strToMap(param);// treeMap默认会以key值升序排序
		StringBuilder sb = new StringBuilder();
		sb.append(mapping).append(mapToStr(treeMap)).append(key);
